...
const MainLoginForm = () => {
  ...
  return (
    <>
      ...
      {/* Footer with sponsorship text */}
      <footer className="w-full mt-8 py-4 border-t border-gray-200">
        <p className="text-center text-sm text-gray-600">
          Sponsored and Financed by Lira University
        </p>
      </footer>
    </>
  );
